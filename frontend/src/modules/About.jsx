    ...
    <section className="p-5 md:p-10 flex md:flex-row items-center justify-center container mx-auto relative">
      <span
        className={`hidden md:block aspect-square w-[5%] mr-2 rounded-full absolute top-[50%] left-0 ${
          theme === "light" ? "bg-secondary" : "bg-violet-900"
        }`}
      ></span>
      <article className=" relative flex flex-col items-center gap-10 border shadow-md border-primary-dark rounded-xl md:rounded-2xl xl:rounded-full  px-4 md:px-0 bg-secondary bg-opacity-10 py-10 ">
